...
~~~~
;; Good one:
(doubled-penalty undertricks vulnerable) produces the penalty points given the number of **undertricks** and knowing if the contract is **vulnerable**, assuming it has been doubled.
